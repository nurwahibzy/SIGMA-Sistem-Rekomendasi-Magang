...
class AkunController extends Controller
{
    public function getProfil()
    {
        ...
        // return response()->json($akun->mahasiswa);
    }
    ...
    {
        $akun = AkunModel::with('mahasiswa:id_mahasiswa,id_akun,nim,nama,alamat,telepon,tanggal_lahir,email')
            ->where('id_akun', Auth::user()->id_akun)
            ->first(['id_akun', 'foto_path']);
