                ...
                <div class="header-top">
                    <div class="container">
                        ...
                        <div class="header-top-right">
                            <!-- Tombol Login -->
                            <button class="btn btn-primary font-bold" href="#">
                                Login
                            </button>
                        ...
                        <ul>
                            <li class="menu-item has-sub">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                                    <span><i class="bi bi-stack"></i> Dashboard</span>
                                </a>
                            </li>
                            ...
                            <li class="menu-item active has-sub">
                                <a href="#" class='menu-link'>
                                    <span><i class="bi bi-grid-1x2-fill"></i> Perusahaan Mitra</span>
                                </a>
                            </li>

                            <li class="menu-item  has-sub">
                                <a href="#" class='menu-link'>
                                    <span><i class="bi bi-file-earmark-medical-fill"></i> Layanan</span>
                                </a>
                            </li>

                            <li class="menu-item  has-sub">
                                <a href="#" class='menu-link'>
                                    <span><i class="bi bi-file-earmark-medical-fill"></i> FAQ</span>
                                </a>
                            </li>
                        </ul>
                    </div>
