...
<div class="col-md-4">
    <div class="position-sticky" style="top: 90px;">
        <div class="card p-4 text-center">
            ...
            <div id="profile-image-container" class="position-relative mx-auto mb-3"
                style="width: 100px; height: 100px;">
                <img id="profile-image"
                    src="{{ asset(Auth::user()->mahasiswa->foto ?? 'template/assets/images/mhs.jpeg') }}"
                    alt="Profile Picture" class="rounded-circle d-block" width="100" height="100"
                    style="border: 5px solid blue; object-fit: cover;">

                <div id="image-upload-container" class="d-none"
                    style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 10;">
                    <div
                        class="d-flex flex-column justify-content-center align-items-center h-100 rounded-circle bg-dark bg-opacity-50">
