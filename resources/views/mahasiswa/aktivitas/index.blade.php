...
@section('content') <div class="page-heading"> <h3>Log Aktivitas Magang</h3> </div>
...
<div class="page-content">
    <section class="row">
        <div class="col-12">
            ...
            {{-- Tombol Tambah --}}
            <button class="btn btn-primary mb-3" id="btnTambahAktivitas" data-bs-toggle="modal" data-bs-target="#modalTambah" 
                   {{ $hasActivityToday ? 'disabled' : '' }}>
