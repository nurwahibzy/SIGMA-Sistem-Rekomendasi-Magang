<div class="modal fade" id="modalTambahAdmin" tabindex="-1" aria-labelledby="modalTambahAdminLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="formTambahAdmin">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahAdminLabel">Tambah Program Studi</h5>
...
$(document).ready(function() {
    ...
    $('#formTambahAdmin').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '{{ url("admin/admin/tambah") }}', // ganti sesuai route backend
                method: 'POST',
                data: formData,
