...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button onclick="modalAction('{{ url('/admin/admin/tambah') }}')" class="btn btn-primary"><i class="bi bi-plus"></i>Tambah
                Admin</button>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table" id="table1">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">Tidak ada admin tersedia</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
