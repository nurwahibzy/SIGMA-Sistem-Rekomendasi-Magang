<div class="modal fade" id="modalTambahDosen" tabindex="-1" aria-labelledby="modalTambahDosenLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="formTambahDosen">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahDosenLabel">Tambah Program Studi</h5>
...
$(document).ready(function() {
    ...
    $('#formTambahDosen').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '{{ url("admin/dosen/tambah") }}', // ganti sesuai route backend
                method: 'POST',
                data: formData,
