<div class="modal fade" id="modalTambahPerusahaan" tabindex="-1" aria-labelledby="modalTambahPerusahaanLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="formTambahPerusahaan">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahPerusahaanLabel">Tambah Program Studi</h5>
        ...
        $(document).ready(function () {
            ...
            $('#formTambahPerusahaan').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: '{{ url("admin/perusahaan/tambah") }}', // ganti sesuai route backend
                        method: 'POST',
                        data: formData,
